  ...
  const experiences = [
    {
      ...
      period: "2024 - 2028",
      description: [
        "Studying core CS concepts including OOP, DSA, Database Design, and Information Security.",
        "Completed projects in full-stack development, UI/UX design, and hardware.",
      ]
    },
    {
      ...
      period: "2024",
      description: [
        "Completed certified course covering user research, wireframing, prototyping and Figma.",
        "Learned user-centered design principles and applied them in semester projects.",
      ]
    },
    {
...
period: "Sep 2025",
      description: [
        "Completed certified course covering core Python concepts, file I/O, automation and data structures.",
      ]
    }
  ];
