...
import udemyLogo from '../../assets/badges/udemy.png';
import nustLogo from '../../assets/badges/nust.png';
  ...
  const badges = [
    {
      id: 'uiux-udemy',
      image: udemyLogo,
      alt: 'Udemy Certificate Badge',
      title: 'UI/UX Design',
      subtitle: 'Udemy — Verified Certificate',
      credentialUrl: '',
      status: 'completed'
    },
    {
      id: 'python-nust',
      image: nustLogo,
      alt: 'NUST Certificate Badge',
      title: 'Python Programming',
      subtitle: 'NUST University — Sep 2025',
      credentialUrl: '',
      status: 'completed'
    }
  ];
