...
const Projects = () => {
  ...
  const projects = [
    {
      title: "Task Manager",
      description: "A full-stack task management web app with CRUD functionality, user authentication, task categorization, and status tracking.",
    ...
    {
  title: "OOP Ice Cream Truck",
  description: "An object-oriented programming project simulating an ice cream truck with full OOP principles.",
  technologies: ["OOP", "C++"],
      icon: comingSoon,
    ...
    {
      title: "Learn_Eaze",
      description: "A mobile learning application with a fully designed UI/UX and functional Flutter/Dart app built alongside the design prototype.",
    ...
    },
    {
      ...
      description: "Analyzed a Netflix dataset to extract viewing trends, genre distributions, and content patterns with interactive Power BI dashboards.",
